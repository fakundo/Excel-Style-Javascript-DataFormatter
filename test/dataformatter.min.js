window.DataFormatter = {functions: {}, locale: {months: ["января", "февраля", "марта", "апреля", "мая", "июня", "июля", "августа", "сентября", "октября", "ноября", "декабря"], months_short: ["янв", "фев", "мар", "апр", "май", "июн", "июл", "авг", "сен", "окт", "ноя", "дек"], days: ["воскресенье", "понедельник", "вторник", "среда", "четверг", "пятница", "суббота"], days_short: ["Вс", "Пн", "Вт", "Ср", "Чт", "Пт", "Сб"], thousands_separator: " ", decimal_separator: ",", formats: {"General Number": "#.#", Currency: "#,##0.00р.;[Red]-#,##0.00р.", Fixed: "0.00", Standard: "#,##0.00", Percent: "0.00%", Scientific: "0.00E+00", "Yes/No": '"Да";"Да";"Нет"', "True/False": '"Истина";"Истина";"Ложь"', "On/Off": '"Вкл";"Вкл";"Выкл"', "Short Date": "mm.dd.yyyy", "Long Date": "dd mmmm yyyy", "General Date": "mm.dd.yyyy h:mm", "Medium Date": "dd.mmm.yy", "Long Time": "hh:mm:ss AM/PM", "Short Time": "h:mm", "Medium Time": "hh:mm AM/PM"}}, format: function (n, e, t) {
	...
	return(DataFormatter.functions[t] = Function("n,type", a))(n, e)
}, fillNumberPattern: function (n, e, t) {
	var r, a, m, s, i, l, u, o, f, h, c, g, p, d, y;
	if (n = n.toString(), s = "", "right" === t)for (a = 0, r = l = 0, o = e.length - 1; o >= 0 ? o >= l : l >= o; r = o >= 0 ? ++l : --l)switch (e[r]) {
		case"0":
			s += null != (f = n[a]) ? f : "0", a++;
			break;
		case"#":
		...
		if (i = !1, e = e.replace(/(0|#|\?)(,+?)(0|#|\?)/g, function (n, e, t, r) {
			return i = !0, e + r
		}), i)for (a = n.length - 3; "-" === n[0] ? a > 1 : a > 0;)n = n.substr(0, a) + DataFormatter.locale.thousands_separator + n.substr(a), a -= 3;
		for (a = n.length - 1, r = u = g = e.length - 1; 0 >= g ? 0 >= u : u >= 0; r = 0 >= g ? ++u : --u)switch (e[r]) {
			case"0":
				s = (null != (p = n[a]) ? p : "0") + s, m = r, a--;
				break;
			case"#":
				s = (null != (d = n[a]) ? d : "") + s, m = r, a--;
				break;
			case"?":
				s = (null != (y = n[a]) ? y : " ") + s, m = r, a--;
				break;
			case"]":
				for (; r > 0 && "[" !== e[r];)s = e[r] + s, r--;
				r++;
				break;
			default:
				s = e[r] + s
		}
		a >= 0 && null !== m && (s = s.substr(0, m) + n.substr(0, a + 1) + s.substr(m))
	}
	return s
